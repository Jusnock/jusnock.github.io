...
<div style="display: flex; gap: 8px; margin-bottom: 20px;">
  ...
  <span class="badge-tag">Certificación Internacional</span>
...
pie title Distribución de Dominios CompTIA Security+
    "1.0 Amenazas, Ataques & Vulnerabilidades (24%)" : 24
    "2.0 Arquitectura & Diseño (21%)" : 21
    "3.0 Implementación (25%)" : 25
    "4.0 Operaciones & Respuesta a Incidentes (16%)" : 16
    "5.0 Gobernanza, Riesgo & Cumplimiento (14%)" : 14
```
