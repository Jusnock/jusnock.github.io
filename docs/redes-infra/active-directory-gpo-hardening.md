# Administración de Active Directory & Hardening GPO (Windows Server)
...
Para una administración limpia basada en el principio de mínimo privilegio (*PoLP*), se estructuraron las Unidades Organizativas separando claramente cuentas administrativas, equipos de usuario y servidores:
...
## Protocolo de Respaldo del Directorio (System State Backup)
