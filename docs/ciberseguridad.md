...
<div style="display: flex; gap: 8px; margin-bottom: 20px;">
  <span class="badge-tag">Ciberseguridad</span>
  <span class="badge-tag">Herramientas</span>
  <span class="badge-tag">SecOps</span>
  <span class="badge-tag">Network Security</span>
</div>
...
## Writeups & Laboratorios Técnicos

*Espacio reservado para bitácoras técnicas de laboratorios.*
