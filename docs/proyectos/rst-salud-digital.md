...
<div style="display: flex; gap: 8px; margin-bottom: 20px;">
  ...
  <span class="badge-tag">SQL Optimization</span>
...
* **Período:** Julio 2024 – Agosto 2024
...
* **Control de Versiones y Trabajo Colaborativo:** Integración al flujo de trabajo corporativo con Git, respetando ramas de features, *pull requests* y revisiones de código cruzadas con desarrolladores senior.
